...
client = MongoClient("mongodb+srv://yebe:31happy65@cluster0.pqttkyr.mongodb.net/?appName=Cluster0")
db = client['db1'] #Nombre de tu base de datos aquí
collection = db['usuarios'] #Nombre de tu colección aquí

# Configuración de SendGrid
SENDGRID_API_KEY = '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'  # Usa tu clave API de SendGrid aquí
